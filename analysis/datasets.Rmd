...
write_csv(summary, "../additional/additional16_mads.csv")
```
...
ggsave("../additional/additional9_gene_gof.pdf",
       width = 20, height = 25, units = "cm")
ggsave("../additional/additional9_gene_gof.png",
       width = 20, height = 25, units = "cm")
```
...
ggsave("../additional/additional15_timings.pdf",
       width = 20, height = 25, units = "cm")
ggsave("../additional/additional15_timings.png",
       width = 20, height = 25, units = "cm")
```
