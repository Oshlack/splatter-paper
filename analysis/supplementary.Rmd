...
gg
ggsave("../additional/additional11_meanzeros.png", width = 8, height = 5)
ggsave("../additional/additional11_meanzeros.pdf", width = 8, height = 5)
```
...
gg
ggsave("../additional/additional10_disps.png", width = 8, height = 5)
ggsave("../additional/additional10_disps.pdf", width = 8, height = 5)
```
...
gg
ggsave("../additional/additional9_nonlinear.png", width = 8, height = 5)
ggsave("../additional/additional9_nonlinear.pdf", width = 8, height = 5)
```
...
render("additional_figures.Rmd", output_format = "pdf_document",
       output_file = "additional_figures_1-11.pdf",
...
it out. We are going to render this document as a PDF to be included as an
additional file.

```{r sessionInfo-render, cache = FALSE, results = "hide"}
render("sessionInfo.Rmd", output_format = "pdf_document",
       output_file = "additional13_sessionInfo.pdf",
       output_dir = "../additional", envir = new.env())
```
