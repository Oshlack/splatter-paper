...
gg
ggsave("../additional/additional12_meanzeros.png", width = 8, height = 5)
ggsave("../additional/additional12_meanzeros.pdf", width = 8, height = 5)
```
...
gg
ggsave("../additional/additional11_disps.png", width = 8, height = 5)
ggsave("../additional/additional11_disps.pdf", width = 8, height = 5)
```
...
gg
ggsave("../additional/additional10_nonlinear.png", width = 8, height = 5)
ggsave("../additional/additional10_nonlinear.pdf", width = 8, height = 5)
```
